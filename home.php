                ...
                <div class="row align-items-center">
                  <div class="col-10">
                    <div class="markdown text-muted">
                      <small><b><i>MAGIS - Mandiri Group Integrated System</i></b> adalah portal web yang berfungsi sebagai katalog aplikasi dengan konsep Single Sign-On (SSO), Memungkinkan pengguna untuk mengakses berbagai aplikasi hanya dengan satu kali login.
                      </small>
                    </div>
                  </div>
                </div>
