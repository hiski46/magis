<header class="navbar navbar-expand-md d-print-none">
    <div class="container-xl">
        ...
        <h1
            class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3 animate__animated animate__rubberBand">
            <a href=".">
            ...
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="content.php?v=home">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="content.php?v=manage_apps">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="content.php?v=manage_user">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="content.php?v=documentation">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
