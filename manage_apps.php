                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th><button class="table-sort">Access Token DEV</button></th>
                      <th><button class="table-sort">Access Token PRD</button></th>
                  ...
                  <tbody class="table-tbody">
                    ...
                    <tr>
                      <td class="sort-name"><img src="./static/logo/sisakty_icon.png" style="width: 50px;"></td>
                    ...
                    <tr>
                      <td class="sort-name"><img src="./static/logo/optimals_icon.png" style="width: 50px;"></td>
                      <td class="sort-city">Optimals</td>
                      <td class="sort-type">Optimals adalah aplikasi...</td>
                      <td class="sort-score text-muted">
                        <small><b>Link</b> : https://optimals.mandiricoal.net/<br><b>Token</b> : JIYnuYUY98nJOiuy... <span class="badge bg-azure-lt">Copy</span></small>
                      </td>
                      <td class="sort-score text-muted">
                        <small><b>Link</b> : https://optimals.mandiricoal.co.id/<br><b>Token</b> : JIYnuYUY98nJOiuy... <span class="badge bg-azure-lt">Copy</span></small>
                      </td>
                      <td>
                        <div class="d-flex">
                          <div class="col-xl py-3 p-1">
